...
```
    ...
    ##   <dbl>       <dbl> <fct>     <dbl> <fct>        <dbl> <chr>       <chr> <chr>  
    ## 1     3        62.5 1            16 1             66.8 0.106087034 2     0.1087…
    ## 2     3        62.5 1            16 1             66.8 0.106087034 4     0.1060…
    ## 3     3        62.5 1            16 1             66.8 0.106087034 6     <NA>   
    ## 4     3        62.5 1            16 1             66.8 0.106087034 8     0.1061…
    ## 5     5        66   1            16 0             68.7 0.107950408 2     0.1122…
    ## # ℹ 371 more rows
...
| ratio         |        33 |          0.91 |   9 |  11 |     0 |      343 |          0 |

**Variable type: factor**

| skim_variable | n_missing | complete_rate | ordered | n_unique | top_counts     |
|:--------------|----------:|--------------:|:--------|---------:|:---------------|
| sex           |         0 |             1 | FALSE   |        2 | 1: 200, 0: 176 |
| apoe4         |         0 |             1 | FALSE   |        2 | 1: 240, 0: 136 |

**Variable type: numeric**

| skim_variable | n_missing | complete_rate |   mean |     sd |   p0 |  p25 |   p50 |   p75 |  p100 | hist  |
|:--------------|----------:|--------------:|-------:|-------:|-----:|-----:|------:|------:|------:|:------|
| id            |         0 |             1 | 245.62 | 143.50 |  3.0 | 89.0 | 281.5 | 366.0 | 471.0 | ▇▃▃▇▆ |
| current_age   |         0 |             1 |  65.74 |   2.88 | 58.1 | 63.7 |  66.0 |  67.7 |  71.6 | ▂▅▇▇▅ |
| education     |         0 |             1 |  16.49 |   1.75 | 12.0 | 16.0 |  16.0 |  18.0 |  20.0 | ▁▁▇▂▁ |
| age_at_onset  |         0 |             1 |  70.36 |   3.59 | 61.2 | 68.2 |  70.2 |  73.4 |  77.2 | ▂▃▇▆▅ |

The resulting dataset consists of 376 observations of 9 variables. The
key variables include id, current_age, sex, education, apoe4,
